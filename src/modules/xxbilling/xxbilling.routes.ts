...
xxBillingRouter.post('/subscription/cancel', authMiddleware, cancelSubscription);
xxBillingRouter.delete('/subscription', authMiddleware, cancelSubscription);
xxBillingRouter.patch('/subscription', authMiddleware, updateSubscription);
xxBillingRouter.post('/subscription', authMiddleware, updateSubscription);
...
xxBillingRouter.post('/checkout', authMiddleware, createPaddleCheckout);
xxBillingRouter.post('/create-checkout', authMiddleware, createPaddleCheckout);
xxBillingRouter.post('/sync', authMiddleware, syncSubscriptionFromPaddle);
xxBillingRouter.post('/paddle/sync', authMiddleware, syncSubscriptionFromPaddle);
